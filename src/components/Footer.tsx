...
const Footer = () => {
  ...
  return (
    <footer className="relative" style={{ backgroundColor: '#FFFFFF' }}>
      {/* Newsletter Section */}
      <div className="py-12 border-t border-opacity-20" style={{ backgroundColor: '#F2F3F5', borderColor: '#B3B5BC' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h3 className="text-2xl sm:text-3xl font-bold mb-4" style={{ color: '#1A1818' }}>
              Stay Connected with ToolNTask
            </h3>
            <p className="text-lg mb-8 max-w-2xl mx-auto" style={{ color: '#B3B5BC' }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
              <input
                ...
                style={{ borderColor: '#B3B5BC', color: '#1A1818' }}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="text-3xl sm:text-4xl font-bold mb-6" style={{ color: '#1A1818' }}>
              ...
              <div className="flex flex-wrap gap-6 mb-8">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium" style={{ color: '#1A1818' }}>5,000+ Members</span>
                </div>
                <div className="flex items-center gap-2">
                  <Star className="w-5 h-5" style={{ color: '#FFE514' }} />
                  <span className="text-sm font-medium" style={{ color: '#1A1818' }}>4.8★ Rating</span>
                </div>
                <div className="flex items-center gap-2">
                  <Heart className="w-5 h-5" style={{ color: '#FE5F16' }} />
                  <span className="text-sm font-medium" style={{ color: '#1A1818' }}>100% Secure</span>
                </div>
              </div>
              ...
              <div className="flex space-x-4">
                {[
                  ...
                  >
                    <social.icon className="w-6 h-6 transition-colors group-hover:text-white" style={{ color: '#1A1818' }} />
                  </div>
                ))}
              </div>
            </div>
            ...
            {/* Quick Links */}
            <div>
              <h3 className="text-xl font-bold mb-6" style={{ color: '#1A1818' }}>Explore</h3>
                ...
                {[
                  ...
                  <li key={index}>
                    <Link 
                      ...
                      onMouseLeave={(e) => e.currentTarget.style.color = '#B3B5BC'}
                    >
            ...
            {/* Legal Links */}
            <div>
              <h3 className="text-xl font-bold mb-6" style={{ color: '#1A1818' }}>Legal</h3>
              <ul className="space-y-3">
                {[
            ...
            {/* Contact Info */}
            <div>
              <h3 className="text-xl font-bold mb-6" style={{ color: '#1A1818' }}>Get in Touch</h3>
              <div className="space-y-4">
                {[
                  ...
                  <div key={index} className="flex items-start gap-3 group">
                    ...
                    <div>
                      {contact.href === '#' ? (
                        <span className="text-sm leading-relaxed" style={{ color: '#B3B5BC' }}>
                          {contact.text}
                        </span>
                      ) : (
                        <a 
      ...
      {/* Bottom Bar */}
      <div className="py-6 border-t border-opacity-20" style={{ backgroundColor: '#F2F3F5', borderColor: '#B3B5BC' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-sm text-center sm:text-left" style={{ color: '#B3B5BC' }}>
