...
const FilterButtons: React.FC<FilterButtonsProps> = ({ onFilterChange, activeFilter }) => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto mb-7 filter-container">
      {/* Elegant Thin Wide Filter Widget */}
      <div className="p-2 rounded-full shadow-lg border" style={{ 
          ...
          {filterOptions.map((option) => {
            ...
            return (
              <button
                ...
                className={`
                  flex-1 relative px-5 sm:px-7 py-3 sm:py-3.5 rounded-full 
