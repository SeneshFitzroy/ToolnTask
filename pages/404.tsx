    ...
    <div className="min-h-screen" style={{ backgroundColor: theme === 'dark' ? '#0a0a0a' : '#F2F3F5' }}>
      ...
      <div className="flex items-center justify-center py-16 sm:py-24 lg:py-32 px-4">
        <div className="text-center max-w-md mx-auto">
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold mb-4" style={{ color: theme === 'dark' ? '#FFFFFF' : '#2D3748' }}>404</h1>
          <h2 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6" style={{ color: theme === 'dark' ? '#FF5E14' : '#2D3748' }}>Page Not Found</h2>
