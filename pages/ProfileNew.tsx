...
export default function Profile() {
  ...
  const navigateToCreateTool = () => {
    router.push('/CreateTool');
  };
        ...
        <div className="rounded-3xl shadow-xl p-8 mb-8" style={{ backgroundColor: theme === 'dark' ? '#1a1a1a' : '#FFFFFF' }}>
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex gap-3">
              <Button onClick={navigateToCreateTool} className="bg-orange-500 hover:bg-orange-600 text-white">
                Create Tool
              </Button>
              <Button onClick={navigateToCreateTask} className="bg-blue-500 hover:bg-blue-600 text-white">
                Create Task
              </Button>
            </div>
          </div>
