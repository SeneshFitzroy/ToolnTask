...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: theme === 'dark' ? '#0a0a0a' : '#F2F3F5' }}>
      ...
      <div className="py-12 sm:py-16 lg:py-20" style={{ backgroundColor: theme === 'dark' ? '#2D3748' : '#F2F3F5' }}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16">
            {/* Contact Form */}
            <div className="p-8 sm:p-10 rounded-3xl shadow-xl" style={{ backgroundColor: theme === 'dark' ? '#2D3748' : '#FFFFFF' }}>
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-semibold mb-3" style={{ color: theme === 'dark' ? '#FFFFFF' : '#2D3748' }}>First Name *</label>
                    <input
                      type="text"
                      name="firstName"
                  ...
                  <div>
                    <label className="block text-sm font-semibold mb-3" style={{ color: theme === 'dark' ? '#FFFFFF' : '#2D3748' }}>Last Name *</label>
                    <input
                      type="text"
                      name="lastName"
                ...
                <div>
                  <label className="block text-sm font-semibold mb-3" style={{ color: theme === 'dark' ? '#FFFFFF' : '#2D3748' }}>Email *</label>
                  <input
                    type="email"
                    name="email"
                ...
                <div>
                  <label className="block text-sm font-semibold mb-3" style={{ color: theme === 'dark' ? '#FFFFFF' : '#2D3748' }}>Phone</label>
                  <input
                    type="tel"
                    name="phone"
                ...
                <div>
                  <label className="block text-sm font-semibold mb-3" style={{ color: theme === 'dark' ? '#FFFFFF' : '#2D3748' }}>Subject</label>
                  <input
                    type="text"
                    name="subject"
                ...
                <div>
                  <label className="block text-sm font-semibold mb-3" style={{ color: theme === 'dark' ? '#FFFFFF' : '#2D3748' }}>Message *</label>
                  <textarea
                    rows={6}
                    name="message"
              ...
              <div className="p-8 rounded-3xl shadow-xl hover:scale-105 transition-all duration-300" style={{ backgroundColor: '#FFFFFF' }}>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-bold text-lg mb-2" style={{ color: '#2D3748' }}>Address</h3>
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="w-14 h-14 rounded-full flex items-center justify-center flex-shrink-0 shadow-lg" style={{ backgroundColor: '#FF5E14' }}>
                      <span className="text-xl" style={{ color: '#2D3748' }}>📞</span>
                    </div>
                    <div>
                      <h3 className="font-bold text-lg mb-2" style={{ color: '#2D3748' }}>Phone</h3>
                      <p className="text-lg" style={{ color: '#B3B5BC' }}>+94 11 123 4567</p>
                    </div>
                  </div>
                  
                  <div className="flex items-start space-x-4">
                    <div className="w-14 h-14 rounded-full flex items-center justify-center flex-shrink-0 shadow-lg" style={{ backgroundColor: '#2D3748' }}>
                      <span className="text-white text-xl">✉️</span>
                    </div>
                    <div>
                      <h3 className="font-bold text-lg mb-2" style={{ color: '#2D3748' }}>Email</h3>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-bold text-lg mb-2" style={{ color: '#2D3748' }}>Business Hours</h3>
                ...
                <div className="space-y-6">
                  <div className="p-4 rounded-xl border-l-4" style={{ backgroundColor: '#F2F3F5', borderColor: '#FE5F16' }}>
                    <div className="flex items-center gap-1">
                      <span className="font-bold text-lg" style={{ color: '#2D3748' }}>How do I start using</span>
                      <Logo size="small" />
                      <span className="font-bold text-lg" style={{ color: '#2D3748' }}>?</span>
                    </div>
                  ...
                  <div className="p-4 rounded-xl border-l-4" style={{ backgroundColor: '#F2F3F5', borderColor: '#FF5E14' }}>
                    <h3 className="font-bold text-lg mb-3" style={{ color: '#2D3748' }}>Is there a service fee?</h3>
                  ...
                  <div className="p-4 rounded-xl border-l-4" style={{ backgroundColor: '#F2F3F5', borderColor: '#2D3748' }}>
                    <h3 className="font-bold text-lg mb-3" style={{ color: '#2D3748' }}>How are payments handled?</h3>
