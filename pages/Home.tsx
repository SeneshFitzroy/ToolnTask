      ...
      <div className="py-8 sm:py-12 md:py-16 lg:py-20" style={{ backgroundColor: theme === 'dark' ? '#0C0F16' : '#F2F3F5' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-16 items-center">
            ...
            {/* Hero Video Section - Takes 4 columns */}
            <div className="lg:col-span-4 order-1 lg:order-2">
              <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl mt-4 sm:mt-6 lg:mt-8 xl:mt-12 mx-auto">
                ...
                <div className="mt-6 rounded-xl p-4 border-2 border-dashed border-gray-300 bg-white/50 backdrop-blur-sm text-center">
